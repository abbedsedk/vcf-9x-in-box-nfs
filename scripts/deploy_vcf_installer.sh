...
VCF_INSTALLER_OVA="E:\Offline-Depot-9.0.1.0\PROD\COMP\SDDC_MANAGER_VCF\VCF-SDDC-Manager-Appliance-9.0.1.0.24962180.ova"
...
VCF_INSTALLER_IP=172.17.31.12
VCF_INSTALLER_SUBNET=255.255.255.0
VCF_INSTALLER_GATEWAY=172.17.31.253
